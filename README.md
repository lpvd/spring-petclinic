# Note
This project is a fork of [spring-petclinic](https://github.com/spring-projects/spring-petclinic) for a DevOps course final project. Original code is licensed under Apache 2.0.
